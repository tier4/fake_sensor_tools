...
/**
 * @file rqt_fake_gnss.h
 * @brief RQt plugin class
 */

#ifndef FAKE_GNSS_INCLUDE_RQT_FAKE_GNSS_RQT_FAKE_GNSS_H_
...
{
class FakeGnss : public rqt_gui_cpp::Plugin
{
public:
  /**
   * @brief Constructor.
...
private:
  FakeGnssWidget * widget = nullptr;  //!< @brief RQt plugin widget class
};

}  // namespace rqt_fake_gnss

#endif  // FAKE_GNSS_INCLUDE_RQT_FAKE_GNSS_RQT_FAKE_GNSS_H_
